...
# ^^^^^^^^^^^^^^^^
#
# This module defines :prop_tgt:`IMPORTED` target ``LIBRT::LIBRT``, if LIBRT has
# been found.
#
# Result Variables
# ^^^^^^^^^^^^^^^^
...
# ::
#
# LIBRT_INCLUDE_DIRS  - where to find time.h, etc. LIBRT_LIBRARIES     - List of
# libraries when using librt. LIBRT_FOUND         - True if realtime library
# found.
#
# Hints ^^^^^
#
...
if(LIBRT_FOUND)
  if(NOT TARGET LIBRT::LIBRT)
    ...
    set_target_properties(
      LIBRT::LIBRT
      PROPERTIES IMPORTED_LOCATION "${LIBRT_LIBRARIES}"
